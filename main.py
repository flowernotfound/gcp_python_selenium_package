...
from utils.generate_date_ranges import generate_date_half_ranges
from utils.generate_date_ranges import generate_monthly_date_ranges
import os
...
def reservation_entry(event, context):
    ...
    date_ranges = [];
    date_ranges = generate_date_half_ranges()
